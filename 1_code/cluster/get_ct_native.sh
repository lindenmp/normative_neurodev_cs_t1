ctdir=/Volumes/work_ssd/research_data/PNC/processedData/antsCorticalThickness/
parcdir=/Volumes/work_ssd/research_data/PNC/processedData/gm_vol_masks_native/
